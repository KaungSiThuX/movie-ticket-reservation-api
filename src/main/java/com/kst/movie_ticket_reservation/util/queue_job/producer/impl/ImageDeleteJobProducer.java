...
public class ImageDeleteJobProducer implements JobProducer<ImageDeletePayload>
{
    private final RabbitTemplate rabbitTemplate;

    @Override
    public void produce(ImageDeletePayload payload)
    {
        this.rabbitTemplate.convertAndSend(RabbitMQConfig.topicExchangeName, RabbitMQConfig.imageDeleteRoutingKey
                , payload);
    }
}
